...
<head>
<<<<<<< HEAD:src/main/resources/META-INF/resources/WEB-INF/pages/cra-release.jsp
<meta charset="UTF-8">
<meta charset="utf-8">
	...
	<div class="container">
		...
		<div class="row">
			...
			<article class="col-md maincontent">
				...
				<img src="images/DXgdHWWXcAAw6Ng.jpg" alt="" class="img-responsive" width="360"><br>
				...
				<img src="images/maxresdefault.jpg" alt="" class="img-responsive" width="360"><br>

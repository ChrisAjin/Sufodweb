	...
	<div class="container">
		...
		<div class="row">
			...
			<article class="col-md-4 maincontent">
				...
				<h5>
					<a href="${base}/iopenrage">En savoir plus...</a>
				</h5>
			</article>
			<!-- /Article -->
			<article class="col-md-4 maincontent">
				...
				<p>Le temps des Iop et autres bourrins en mêlée est révolu! A
					l'aide flèches surpruissantes assassiner vos ennemis en restant à
					l'abri des coups avec des flèches dévastatrices. De plus cette
					classe vient avec davantage de contenu !</p>
				<h5>
					<a href="${base}/cra-release">En savoir plus...</a>
				</h5>
			</article>
			<!-- /Article -->
			<article class="col-md-4 maincontent">
				...
				<h5>
					<a href="${base}/owi-ankor">En savoir plus...</a>
				</h5>
			</article>
			<!-- /Article -->
		</div>

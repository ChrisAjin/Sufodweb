...
<body class="home">
	...
	<!-- /container --> <!-- Social links. @TODO: replace by link/instructions in template -->
	<section id="social">
		<div class="container">
	...
	<!-- /social links --> <footer id="footer" class="top-space">
	...
	<script src="assets/js/headroom.min.js"></script> <script
